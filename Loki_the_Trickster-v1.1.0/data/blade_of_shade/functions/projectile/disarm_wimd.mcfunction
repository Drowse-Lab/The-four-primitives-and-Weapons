...
execute at @s[tag=!Loki_Disarm0,tag=!Loki_Disarm_Return] run function blade_of_shade:move
...
#ヒット
execute if entity @s[tag=!Loki_Disarm_Return,scores={BulletRemain=5..}] as @e[distance=..2,type=!item,tag=!Loki_Disarm,type=!area_effect_cloud] at @s run function blade_of_shade:disarm
