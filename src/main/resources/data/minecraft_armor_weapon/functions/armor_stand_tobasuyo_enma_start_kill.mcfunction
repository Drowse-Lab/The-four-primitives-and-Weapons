...
execute anchored eyes as @e[tag=minecraft_armor_weapon_armor_stand_tobasu_main_AS2_INI,limit=1,sort=nearest] run particle witch ^ ^ ^ 1 0 10 100 1000
execute anchored eyes as @e[tag=minecraft_armor_weapon_armor_stand_tobasu_main_AS2_INI,limit=1,sort=nearest] run particle sweep_attack ^ ^ ^ 10 0 0 5 1000
execute anchored eyes as @e[tag=minecraft_armor_weapon_armor_stand_tobasu_main_AS2_INI,limit=1,sort=nearest] run effect give @s minecraft_armor_weapon:armorstandtobasuenmaeffectkill 2 1 true
#########################################################
