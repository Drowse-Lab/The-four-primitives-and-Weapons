...
kill @e[sort=nearest,limit=1,type=item,nbt={Item:{id:"the_four_primitives_and_weapons:wither_bone",Count:16b}}]
kill @e[sort=nearest,limit=1,type=item,nbt={Item:{id:"minecraft:iron_block",Count:64b}}]
effect give @e[sort=nearest,limit=1,type=minecraft:wither_skeleton,tag=hardentity_skeleton] the_four_primitives_and_weapons:hardentity 999999 4
