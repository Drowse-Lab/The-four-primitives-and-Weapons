...
execute anchored eyes as @e[tag=the_four_primitives_and_weapons_armor_stand_tobasu_main_AS2_INI,limit=1,sort=nearest] run effect give @s the_four_primitives_and_weapons:armorstandtobasueffectkill 2 1 true
#########################################################
