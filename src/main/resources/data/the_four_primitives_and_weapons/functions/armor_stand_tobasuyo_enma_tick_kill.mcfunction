#########################################################
execute as @a[scores={the_four_primitives_and_weapons_armor_stand_tobasu_main_AS2_R=1..}] at @s run function the_four_primitives_and_weapons:armor_stand_tobasuyo_enma_start_kill
