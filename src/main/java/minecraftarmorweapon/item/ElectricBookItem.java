...
public class ElectricBookItem extends Item implements ICurioItem {
	...
	public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
		...
		if (lv >= 1 && lv <= 10) {
			tooltip.add(Component.literal("§e").append(Component.translatable("tooltip.minecraft_armor_weapon.element.electric")).append(Component.literal(" " + ElementalTooltipEvent.toRoman(lv))));
		} else if (lv != 0) {
