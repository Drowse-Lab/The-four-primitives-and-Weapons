...
public class WindStepItem extends Item implements ICurioItem {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		minecraftarmorweapon.MinecraftArmorWeaponMod.LOGGER.info("WindStepItem.use() called! World: {}, Hand: {}", world.isClientSide ? "CLIENT" : "SERVER", hand);
		...
		minecraftarmorweapon.MinecraftArmorWeaponMod.LOGGER.info("WindStepItem: Calling WindStepYoukuritukusitatokiProcedure.execute()");
