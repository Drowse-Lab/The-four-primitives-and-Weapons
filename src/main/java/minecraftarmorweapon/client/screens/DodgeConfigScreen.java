...
public class DodgeConfigScreen extends Screen {
    ...
    public DodgeConfigScreen(Screen parent) {
        super(Component.translatable("screen.minecraft_armor_weapon.dodge_config.title"));
        this.parent = parent;
    }
    ...
    private Component getFunctionalBlockText() {
        ...
        return Component.translatable("screen.minecraft_armor_weapon.dodge_config.functional_block").append(": ").append(status);
    }
    ...
    private Component getInertItemText() {
        Component status = DodgeConfig.dodgeWithInertItems
                ? Component.literal("§aON")
                : Component.literal("§cOFF");
        return Component.translatable("screen.minecraft_armor_weapon.dodge_config.inert_item").append(": ").append(status);
    }
    ...
    private Component getActiveItemText() {
        Component status = DodgeConfig.dodgeWithActiveItems
                ? Component.literal("§aON")
                : Component.literal("§cOFF");
        return Component.translatable("screen.minecraft_armor_weapon.dodge_config.active_item").append(": ").append(status);
    }
    ...
    private Component getDodgeDisabledText() {
        ...
        return Component.translatable("screen.minecraft_armor_weapon.dodge_config.disabled").append(": ").append(status);
    }
}
