...
public class RpgBookGuiScreen extends AbstractContainerScreen<RpgBookGuiMenu> {
	...
	protected void renderBg(GuiGraphics ms, float partialTicks, int gx, int gy) {
		...
		ms.blit(new ResourceLocation("minecraft_armor_weapon:textures/screens/img_0974.png"), this.leftPos + -57, this.topPos + -6, 0, 0, 320, 213, 320, 213);
	...
	public void init() {
		super.init();
		button_bogged_outer = Button.builder(Component.translatable("gui.minecraft_armor_weapon.rpg_book_gui.button_bogged_outer"), e -> {
			if (true) {
		...
		button_magic_swordsman = Button.builder(Component.translatable("gui.minecraft_armor_weapon.rpg_book_gui.button_magic_swordsman"), e -> {
			if (true) {
		...
		button_ninja = Button.builder(Component.translatable("gui.minecraft_armor_weapon.rpg_book_gui.button_ninja"), e -> {
			if (true) {
		...
		button_vampire = Button.builder(Component.translatable("gui.minecraft_armor_weapon.rpg_book_gui.button_vampire"), e -> {
			if (true) {
		...
		button_nigu = Button.builder(Component.translatable("gui.minecraft_armor_weapon.rpg_book_gui.button_nigu"), e -> {
			if (true) {
		...
		button_chuzume = Button.builder(Component.translatable("gui.minecraft_armor_weapon.rpg_book_gui.button_chuzume"), e -> {
			if (true) {
