...
public class RarityForgeRegistration {
    ...
    public static void onRegister(RegisterEvent event) {
        event.register(ForgeRegistries.Keys.BLOCKS, helper -> {
            ...
            helper.register(new ResourceLocation("minecraft_armor_weapon", "rarity_forge"), block);
        });
        event.register(ForgeRegistries.Keys.ITEMS, helper -> {
            item = new BlockItem(block, new Item.Properties().tab(MinecraftArmorWeaponModTabs.TAB_WEAPON));
            helper.register(new ResourceLocation("minecraft_armor_weapon", "rarity_forge"), item);
        });
        event.register(ForgeRegistries.Keys.BLOCK_ENTITY_TYPES, helper -> {
            blockEntityType = BlockEntityType.Builder.of(RarityForgeBlockEntity::new, block).build(null);
            helper.register(new ResourceLocation("minecraft_armor_weapon", "rarity_forge"), blockEntityType);
        });
        event.register(ForgeRegistries.Keys.MENU_TYPES, helper -> {
            menuType = IForgeMenuType.create(RarityForgeMenu::new);
            helper.register(new ResourceLocation("minecraft_armor_weapon", "rarity_forge_menu"), menuType);
        });
    }
