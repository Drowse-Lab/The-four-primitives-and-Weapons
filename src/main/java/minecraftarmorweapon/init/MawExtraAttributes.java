...
public class MawExtraAttributes {
    ...
    public static final DeferredRegister<Attribute> ATTRIBUTES =
        DeferredRegister.create(ForgeRegistries.ATTRIBUTES, MinecraftArmorWeaponMod.MODID);

    public static final RegistryObject<Attribute> MANA_MAX =
        ATTRIBUTES.register("mana_max",
            () -> new RangedAttribute(
                "attribute." + MinecraftArmorWeaponMod.MODID + ".mana_max",
                /* default */ 100.0,
                /* min     */ 0.0,
                /* max     */ 2_000_000_000.0
            ).setSyncable(true));
    ...
    public static final RegistryObject<Attribute> MANA_REGEN =
        ATTRIBUTES.register("mana_regen",
            () -> new RangedAttribute(
                "attribute." + MinecraftArmorWeaponMod.MODID + ".mana_regen",
                /* default */ 0.1,
                /* min     */ 0.0,
                /* max     */ 1000.0
            ).setSyncable(true));
