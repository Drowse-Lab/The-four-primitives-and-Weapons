...
public class MobWeaponAIHandler {
    ...
    private static int getWeaponTier(ItemStack weapon) {
        ...
        // ティア7: 神聖級（最強）
        if (weapon.getItem() == MinecraftArmorWeaponModItems.SWORD_OF_NIGHT.get() ||
            weapon.getItem() == MinecraftArmorWeaponModItems.LUNA.get() ||
            weapon.getItem() == MinecraftArmorWeaponModItems.LOKI_THE_TRICKSTER.get()) {
            return 7;
        }

        // ティア6: 天使級
        if (weapon.getItem() == MinecraftArmorWeaponModItems.MAGISCHES_FEEN_KATANA.get() ||
            itemName.contains("Feen")) {
            return 6;
        }

        // ティア5: 神話級
        if (weapon.getItem() == MinecraftArmorWeaponModItems.MAGICAL_KATANA.get() ||
        ...
        if (weapon.getItem() == MinecraftArmorWeaponModItems.RIVERS_OF_BLOOD.get() ||
            weapon.getItem() == MinecraftArmorWeaponModItems.REPLICA_SWORD_OF_LIGHT.get() ||
            weapon.getItem() == MinecraftArmorWeaponModItems.KURIKARAKEN.get() ||
            itemName.contains("Kurikara")) {
            return 4;
        }

        // ティア3: 特異点
        if (weapon.getItem() == MinecraftArmorWeaponModItems.DARKNESS_KATANA.get() ||
            weapon.getItem() == MinecraftArmorWeaponModItems.PROTOTYPE_KATANA.get() ||
            weapon.getItem() == MinecraftArmorWeaponModItems.OLD_KATANA.get() ||
