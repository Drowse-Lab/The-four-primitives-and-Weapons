...
public class AIEvolutionManager {
    ...
    static {
        ...
        ENTITY_TO_LISP.put("the_four_primitives_and_weapons:common_soldier", "common_soldier");
        ENTITY_TO_LISP.put("the_four_primitives_and_weapons:elite_soldier", "elite_soldier");
        ENTITY_TO_LISP.put("the_four_primitives_and_weapons:singularity", "singularity");
        ENTITY_TO_LISP.put("the_four_primitives_and_weapons:heroic_tier", "heroic_tier");
        ENTITY_TO_LISP.put("the_four_primitives_and_weapons:mythical_tier", "mythical_tier");
        ENTITY_TO_LISP.put("the_four_primitives_and_weapons:angel_tier", "angel_tier");
        ENTITY_TO_LISP.put("the_four_primitives_and_weapons:divine_tier", "divine_tier");
        ENTITY_TO_LISP.put("the_four_primitives_and_weapons:angel_serious", "angel_trio");
        ENTITY_TO_LISP.put("the_four_primitives_and_weapons:angel_mocker1", "angel_trio");
        ENTITY_TO_LISP.put("the_four_primitives_and_weapons:angel_mocker2", "angel_trio");
    }
    ...
    public static void loadFromWorld(ServerLevel level) {
        EvolutionSavedData data = level.getDataStorage().computeIfAbsent(
            EvolutionSavedData::load, EvolutionSavedData::new, "the_four_primitives_and_weapons_ai_evolution");
        pools.clear();
