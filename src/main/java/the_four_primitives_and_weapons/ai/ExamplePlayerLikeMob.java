...
public class ExamplePlayerLikeMob extends Monster {
    ...
    private ItemStack getWeaponForTier(int tier) {
        switch (tier) {
            case 1:
                return new ItemStack(TheFourPrimitivesAndWeaponsModItems.IRON_KATANA.get());
            case 2:
                return new ItemStack(TheFourPrimitivesAndWeaponsModItems.GOLD_KATANA.get());
            case 3:
                return new ItemStack(TheFourPrimitivesAndWeaponsModItems.WITHER_KATANA.get());
            case 4:
                return new ItemStack(TheFourPrimitivesAndWeaponsModItems.REPLICA_SWORD_OF_LIGHT.get());
            case 5:
                return new ItemStack(TheFourPrimitivesAndWeaponsModItems.MAGICAL_KATANA.get());
            case 6:
                return new ItemStack(TheFourPrimitivesAndWeaponsModItems.MAGISCHES_FEEN_KATANA.get());
            case 7:
                return new ItemStack(TheFourPrimitivesAndWeaponsModItems.SWORD_OF_NIGHT.get());
            default:
