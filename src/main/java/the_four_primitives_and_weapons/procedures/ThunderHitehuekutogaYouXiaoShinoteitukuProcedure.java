	...
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
			_entity.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN,
					entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(TheFourPrimitivesAndWeaponsModMobEffects.THUNDER_HIT.get()) ? _livEnt.getEffect(TheFourPrimitivesAndWeaponsModMobEffects.THUNDER_HIT.get()).getDuration() : 0, 6, true, false));
