...
public class RkigaYasaretatokiProcedure {
	public static void execute(Entity entity) {
		...
		if (mainHandItem.getItem() == TheFourPrimitivesAndWeaponsModItems.BLUEPURGE.get()
				|| mainHandItem.getItem() == TheFourPrimitivesAndWeaponsModItems.BLUEPURGE_TYOKUTOU.get()
				|| mainHandItem.getItem() == TheFourPrimitivesAndWeaponsModItems.BLUEPURGE_UTIGATANA.get()) {
			...
			if (state == 0) {
				...
				if (entityData.contains("CoverUp")) {
					...
					if (entity instanceof Player player) {
						player.displayClientMessage(Component.translatable("message.the_four_primitives_and_weapons.coverup_limit"), true);
					}
