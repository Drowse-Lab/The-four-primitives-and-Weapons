...
public class WindStepYoukuritukusitatokiProcedure {
	public static void execute(Entity entity) {
		the_four_primitives_and_weapons.TheFourPrimitivesAndWeaponsMod.LOGGER.info("WindStepYoukuritukusitatokiProcedure.execute() called!");

		if (entity == null) {
			the_four_primitives_and_weapons.TheFourPrimitivesAndWeaponsMod.LOGGER.warn("WindStep: Entity is null!");
			return;
		}

		the_four_primitives_and_weapons.TheFourPrimitivesAndWeaponsMod.LOGGER.info("WindStep: Entity: {}, Client side: {}", entity, entity.level().isClientSide);

		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == TheFourPrimitivesAndWeaponsModItems.WIND_STEP.get()
			...
			the_four_primitives_and_weapons.TheFourPrimitivesAndWeaponsMod.LOGGER.info("WindStep: Item check passed!");

			if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
				_entity.addEffect(new MobEffectInstance(TheFourPrimitivesAndWeaponsModMobEffects.WIND_STEP_EFFECT.get(), 100, 1, true, false));
			...
			if (!entity.level().isClientSide && entity instanceof Player player) {
				...
				// デバッグ: エンティティタイプの確認
				the_four_primitives_and_weapons.TheFourPrimitivesAndWeaponsMod.LOGGER.info("WindStep: Attempting to spawn tornado...");
				the_four_primitives_and_weapons.TheFourPrimitivesAndWeaponsMod.LOGGER.info("WindStep: EntityType present: {}", TheFourPrimitivesAndWeaponsModCustomEntities.TORNADO.isPresent());

				if (!TheFourPrimitivesAndWeaponsModCustomEntities.TORNADO.isPresent()) {
					the_four_primitives_and_weapons.TheFourPrimitivesAndWeaponsMod.LOGGER.error("WindStep: TORNADO EntityType is not registered!");
					return;
				}
				...
				the_four_primitives_and_weapons.TheFourPrimitivesAndWeaponsMod.LOGGER.info("WindStep: Tornado spawned: {} at {}, {}, {}", spawned, spawnPos.x, spawnPos.y, spawnPos.z);
