...
public class StormYoukuritukusitatokiProcedure {
	public static void execute(Entity entity) {
		the_four_primitives_and_weapons.TheFourPrimitivesAndWeaponsMod.LOGGER.info("StormYoukuritukusitatokiProcedure.execute() called!");

		if (entity == null) {
			the_four_primitives_and_weapons.TheFourPrimitivesAndWeaponsMod.LOGGER.warn("Storm: Entity is null!");
			return;
		}

		the_four_primitives_and_weapons.TheFourPrimitivesAndWeaponsMod.LOGGER.info("Storm: Entity: {}, Client side: {}", entity, entity.level().isClientSide);
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == TheFourPrimitivesAndWeaponsModItems.STORM.get()
			...
			the_four_primitives_and_weapons.TheFourPrimitivesAndWeaponsMod.LOGGER.info("Storm: Item check passed!");
			if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
				_entity.addEffect(new MobEffectInstance(TheFourPrimitivesAndWeaponsModMobEffects.STORM_EFFECT.get(), 100, 2, true, false));
			...
			if (!entity.level().isClientSide && entity instanceof Player player) {
				...
				// デバッグ: エンティティタイプの確認
				the_four_primitives_and_weapons.TheFourPrimitivesAndWeaponsMod.LOGGER.info("Storm: Attempting to spawn tornadoes...");
				the_four_primitives_and_weapons.TheFourPrimitivesAndWeaponsMod.LOGGER.info("Storm: EntityType present: {}", TheFourPrimitivesAndWeaponsModCustomEntities.TORNADO.isPresent());

				if (!TheFourPrimitivesAndWeaponsModCustomEntities.TORNADO.isPresent()) {
					the_four_primitives_and_weapons.TheFourPrimitivesAndWeaponsMod.LOGGER.error("Storm: TORNADO EntityType is not registered!");
					return;
				}
				...
				// 中央の竜巻エンティティを作成
				TornadoEntity tornado = new TornadoEntity(TheFourPrimitivesAndWeaponsModCustomEntities.TORNADO.get(), level);
				...
				the_four_primitives_and_weapons.TheFourPrimitivesAndWeaponsMod.LOGGER.info("Storm: Center tornado spawned: {} at {}, {}, {}", spawned, spawnPos.x, spawnPos.y, spawnPos.z);
				...
				for (int i = -1; i <= 1; i++) {
					...
					TornadoEntity sideTornado = new TornadoEntity(TheFourPrimitivesAndWeaponsModCustomEntities.TORNADO.get(), level);
					...
					the_four_primitives_and_weapons.TheFourPrimitivesAndWeaponsMod.LOGGER.info("Storm: Side tornado {} spawned: {}", i, sideSpawned);
				}
