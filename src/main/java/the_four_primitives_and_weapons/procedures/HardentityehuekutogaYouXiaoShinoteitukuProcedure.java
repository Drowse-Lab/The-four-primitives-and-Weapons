...
public class HardentityehuekutogaYouXiaoShinoteitukuProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (entity instanceof WitherSkeleton || entity instanceof Stray || entity instanceof Skeleton) {
			if (!((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.HEAD) : ItemStack.EMPTY).getItem() == TheFourPrimitivesAndWeaponsModItems.DAS_HERZ_EINER_FEE_ARMOR_HELMET.get())) {
				{
					Entity _entity = entity;
					if (_entity instanceof Player _player) {
						_player.getInventory().armor.set(3, new ItemStack(TheFourPrimitivesAndWeaponsModItems.DAS_HERZ_EINER_FEE_ARMOR_HELMET.get()));
						_player.getInventory().setChanged();
					} else if (_entity instanceof LivingEntity _living) {
						_living.setItemSlot(EquipmentSlot.HEAD, new ItemStack(TheFourPrimitivesAndWeaponsModItems.DAS_HERZ_EINER_FEE_ARMOR_HELMET.get()));
					}
				}
				try {
					((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.HEAD) : ItemStack.EMPTY)).enchant(Enchantments.ALL_DAMAGE_PROTECTION,
							entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(TheFourPrimitivesAndWeaponsModMobEffects.HARDENTITY.get()) ? _livEnt.getEffect(TheFourPrimitivesAndWeaponsModMobEffects.HARDENTITY.get()).getAmplifier() : 0);
				} catch (Exception e) {
					// Handle enchantment exceptions
				}
			}
			if (!((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.CHEST) : ItemStack.EMPTY).getItem() == TheFourPrimitivesAndWeaponsModItems.DAS_HERZ_EINER_FEE_ARMOR_CHESTPLATE.get())) {
				{
					Entity _entity = entity;
					if (_entity instanceof Player _player) {
						_player.getInventory().armor.set(2, new ItemStack(TheFourPrimitivesAndWeaponsModItems.DAS_HERZ_EINER_FEE_ARMOR_CHESTPLATE.get()));
						_player.getInventory().setChanged();
					} else if (_entity instanceof LivingEntity _living) {
						_living.setItemSlot(EquipmentSlot.CHEST, new ItemStack(TheFourPrimitivesAndWeaponsModItems.DAS_HERZ_EINER_FEE_ARMOR_CHESTPLATE.get()));
					}
				}
				try {
			...
			if (!((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.LEGS) : ItemStack.EMPTY).getItem() == TheFourPrimitivesAndWeaponsModItems.DAS_HERZ_EINER_FEE_ARMOR_LEGGINGS.get())) {
				{
					Entity _entity = entity;
					if (_entity instanceof Player _player) {
						_player.getInventory().armor.set(1, new ItemStack(TheFourPrimitivesAndWeaponsModItems.DAS_HERZ_EINER_FEE_ARMOR_LEGGINGS.get()));
						_player.getInventory().setChanged();
					} else if (_entity instanceof LivingEntity _living) {
						_living.setItemSlot(EquipmentSlot.LEGS, new ItemStack(TheFourPrimitivesAndWeaponsModItems.DAS_HERZ_EINER_FEE_ARMOR_LEGGINGS.get()));
					}
				}
				try {
			...
			if (!((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.FEET) : ItemStack.EMPTY).getItem() == TheFourPrimitivesAndWeaponsModItems.DAS_HERZ_EINER_FEE_ARMOR_BOOTS.get())) {
				{
					Entity _entity = entity;
					if (_entity instanceof Player _player) {
						_player.getInventory().armor.set(0, new ItemStack(TheFourPrimitivesAndWeaponsModItems.DAS_HERZ_EINER_FEE_ARMOR_BOOTS.get()));
						_player.getInventory().setChanged();
					} else if (_entity instanceof LivingEntity _living) {
						_living.setItemSlot(EquipmentSlot.FEET, new ItemStack(TheFourPrimitivesAndWeaponsModItems.DAS_HERZ_EINER_FEE_ARMOR_BOOTS.get()));
					}
				}
				try {
				...
				if (nearestPlayer != null && entity instanceof Mob _mobEntity) {
					...
					if (!((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == TheFourPrimitivesAndWeaponsModItems.WITHER_KATANA.get())) {
						if (entity instanceof LivingEntity _livingEntity1) {
							ItemStack _setstack = new ItemStack(TheFourPrimitivesAndWeaponsModItems.WITHER_KATANA.get());
