...
public class RpgBookGuiNiguTapProcedure {
	public static void execute(Entity entity) {
		...
		if (entity instanceof Player _player) {
			ItemStack _setstack = new ItemStack(TheFourPrimitivesAndWeaponsModItems.KATANA_NIGU_HUMERUS.get());
			_setstack.setCount(1);
			ItemHandlerHelper.giveItemToPlayer(_player, _setstack);
		}
		if (entity instanceof Player _player) {
			ItemStack _setstack = new ItemStack(TheFourPrimitivesAndWeaponsModItems.NIGU_SHIELD.get());
			_setstack.setCount(1);
			ItemHandlerHelper.giveItemToPlayer(_player, _setstack);
		}
