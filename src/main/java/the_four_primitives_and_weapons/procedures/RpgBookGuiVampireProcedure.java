	...
	public static void execute(Entity entity) {
		...
		if (Mth.nextInt(RandomSource.create(), 0, 3) == 1) {
			if (entity instanceof ServerPlayer _player) {
				Advancement _adv = _player.server.getAdvancements().getAdvancement(new ResourceLocation("the_four_primitives_and_weapons:you_have_become_a_vampire"));
			...
			if (entity instanceof Player _player) {
				ItemStack _setstack = new ItemStack(TheFourPrimitivesAndWeaponsModItems.RIVERS_OF_BLOOD.get());
