...
/**
 * 大日本軍 軍服 — カスタム3D（ピークドキャップ＋詰襟チュニック）。 軽装（革～銅程度）。
 */
public abstract class ImperialArmyUniformItem extends ArmorItem {

	private static final String TEXTURE = "the_four_primitives_and_weapons:textures/entities/imperial_army_uniform.png";
	private static final String GLOVES = "the_four_primitives_and_weapons:textures/entities/imperial_army_gloves.png";

	public ImperialArmyUniformItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends ImperialArmyUniformItem {
	...
	public static class Chestplate extends ImperialArmyUniformItem implements DyeableLeatherItem {
	...
	public static class Leggings extends ImperialArmyUniformItem {
	...
	public static class Boots extends ImperialArmyUniformItem {
