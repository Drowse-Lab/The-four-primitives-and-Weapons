...
/**
 * 警視抜刀隊 警部 制服（シングルボタン/太線/革靴）。 軽装（革～銅程度）。
 */
public abstract class KeishiOfficerUniformItem extends ArmorItem {

	private static final String TEXTURE = "the_four_primitives_and_weapons:textures/entities/keishi_officer_uniform.png";
	private static final String GLOVES = "the_four_primitives_and_weapons:textures/entities/keishi_officer_gloves.png";

	public KeishiOfficerUniformItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends KeishiOfficerUniformItem {
	...
	public static class Chestplate extends KeishiOfficerUniformItem implements DyeableLeatherItem {
	...
	public static class Leggings extends KeishiOfficerUniformItem {
	...
	public static class Boots extends KeishiOfficerUniformItem {
