...
public class ReitouItem extends SwordItem {
	...
	public void appendHoverText(ItemStack stack, @Nullable Level world, List<Component> tooltip, TooltipFlag flag) {
		...
		tooltip.add(Component.translatable("tooltip.the_four_primitives_and_weapons.reitou.desc1")
				.setStyle(Style.EMPTY.withColor(TextColor.parseColor("#8844AA")).withItalic(true)));
		tooltip.add(Component.translatable("tooltip.the_four_primitives_and_weapons.reitou.desc2")
				.setStyle(Style.EMPTY.withColor(TextColor.parseColor("#666666")).withItalic(false)));
		tooltip.add(Component.translatable("tooltip.the_four_primitives_and_weapons.reitou.desc3")
