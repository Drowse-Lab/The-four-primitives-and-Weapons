package the_four_primitives_and_weapons.item.base;
...
import the_four_primitives_and_weapons.item.renderer.DynamicTextureItemRenderer;
import net.minecraft.client.renderer.BlockEntityWithoutLevelRenderer;
import java.util.function.Consumer;

public abstract class Base3DModelSwordItem extends SwordItem {
    
    public Base3DModelSwordItem(Tier tier, int attackDamageModifier, float attackSpeedModifier, Properties properties) {
