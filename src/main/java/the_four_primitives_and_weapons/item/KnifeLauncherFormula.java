 ...
 *
 * 起動時に一度だけ {@code data/the_four_primitives_and_weapons/knife_launcher/formula.lisp} を読み込み、
...
public final class KnifeLauncherFormula {
    ...
    private static final ResourceLocation FORMULA_PATH =
        new ResourceLocation("the_four_primitives_and_weapons", "knife_launcher/formula.lisp");
    ...
    static {
        try {
            java.io.InputStream in = KnifeLauncherFormula.class.getClassLoader()
                .getResourceAsStream("data/the_four_primitives_and_weapons/knife_launcher/formula.lisp");
            if (in != null) {
                StringBuilder sb = new StringBuilder();
    ...
    public static int getInt(String symbol, int fallback) {
        ...
        Object v = INTERPRETER.eval(new the_four_primitives_and_weapons.ai.lisp.LispInterpreter.Symbol(symbol));
