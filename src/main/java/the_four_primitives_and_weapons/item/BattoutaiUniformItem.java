...
/**
 * 抜刀隊 制服 — カスタム3D（手は白手袋・染色可）。 軽装（革～銅程度）。
 */
public abstract class BattoutaiUniformItem extends ArmorItem {
	...
	private static final String GLOVES = "the_four_primitives_and_weapons:textures/entities/battoutai_gloves.png";
	...
	public static class Chestplate extends BattoutaiUniformItem implements DyeableLeatherItem {
