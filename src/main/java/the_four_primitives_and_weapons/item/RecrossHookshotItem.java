...
public class RecrossHookshotItem extends Item {
    ...
    private int getEffectiveCooldown(ItemStack stack) {
        var rarity = the_four_primitives_and_weapons.item.rarity.WeaponRarity.getFromStack(stack);
    ...
    public boolean isFoil(ItemStack stack) {
        ...
        var r = the_four_primitives_and_weapons.item.rarity.WeaponRarity.getFromStack(stack);
        return r != null && r.ordinal() >= the_four_primitives_and_weapons.item.rarity.WeaponRarity.LEGENDARY.ordinal();
    }
