...
import the_four_primitives_and_weapons.procedures.TobeposiyonnoXiaoGuogaKaiShiShiYongsaretatokiProcedure;
...
public class TobeMobEffect extends MobEffect {
	...
	public String getDescriptionId() {
		return "effect.the_four_primitives_and_weapons.tobe";
	}
	...
	public void applyEffectTick(LivingEntity entity, int amplifier) {
		TobeposiyonnoXiaoGuogaKaiShiShiYongsaretatokiProcedure.execute(VersionHelper.getLevel(entity), entity);
	}
