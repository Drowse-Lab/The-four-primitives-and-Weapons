...
import the_four_primitives_and_weapons.procedures.ZanngekitokubetuehuekutogaYouXiaoShinoteitukuProcedure;
...
public class ZanngekitokubetuMobEffect extends MobEffect {
	...
	public String getDescriptionId() {
		return "effect.the_four_primitives_and_weapons.zanngekitokubetu";
	}
	...
	public void applyEffectTick(LivingEntity entity, int amplifier) {
		ZanngekitokubetuehuekutogaYouXiaoShinoteitukuProcedure.execute(VersionHelper.getLevel(entity), entity);
	}
