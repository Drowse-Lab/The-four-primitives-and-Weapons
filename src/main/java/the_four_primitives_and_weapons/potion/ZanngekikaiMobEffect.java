...
import the_four_primitives_and_weapons.procedures.ZanngekikaiehuekutogaYouXiaoShinoteitukuProcedure;
...
public class ZanngekikaiMobEffect extends MobEffect {
	...
	public String getDescriptionId() {
		return "effect.the_four_primitives_and_weapons.zanngekikai";
	}
	...
	public void applyEffectTick(LivingEntity entity, int amplifier) {
		ZanngekikaiehuekutogaYouXiaoShinoteitukuProcedure.execute(VersionHelper.getLevel(entity), entity);
	}
