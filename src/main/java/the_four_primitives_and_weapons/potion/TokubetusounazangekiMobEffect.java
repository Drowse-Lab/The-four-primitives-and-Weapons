...
import the_four_primitives_and_weapons.procedures.TokubetusounazangekiehuekutogaYouXiaoShinoteitukuProcedure;
...
public class TokubetusounazangekiMobEffect extends MobEffect {
	...
	public String getDescriptionId() {
		return "effect.the_four_primitives_and_weapons.tokubetusounazangeki";
	}
	...
	public void applyEffectTick(LivingEntity entity, int amplifier) {
		TokubetusounazangekiehuekutogaYouXiaoShinoteitukuProcedure.execute(VersionHelper.getLevel(entity), entity);
	}
