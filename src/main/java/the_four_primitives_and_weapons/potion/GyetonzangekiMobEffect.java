...
import the_four_primitives_and_weapons.procedures.GyetonzangekiehuekutogaYouXiaoShinoteitukuProcedure;
...
public class GyetonzangekiMobEffect extends MobEffect {
	...
	public String getDescriptionId() {
		return "effect.the_four_primitives_and_weapons.gyetonzangeki";
	}
	...
	public void applyEffectTick(LivingEntity entity, int amplifier) {
		GyetonzangekiehuekutogaYouXiaoShinoteitukuProcedure.execute(VersionHelper.getLevel(entity), entity);
	}
