...
//package the_four_primitives_and_weapons.entity.ai;

import net.minecraft.world.entity.Mob;
import net.minecraft.world.entity.LivingEntity;
import net.minecraft.world.entity.ai.goal.MeleeAttackGoal;
import the_four_primitives_and_weapons.entity.ai.CustomMeleeAttackGoal;
...
public class FlyingAttackerEntity extends Monster {
    ...
    public FlyingAttackerEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(TheFourPrimitivesAndWeaponsModEntities.FLYING_ATTACKER.get(), world);
    }
                        ...
                        for (LivingEntity nearbyEntity : nearbyTargets) {
                            if (nearbyEntity != null && nearbyEntity != target && nearbyEntity != this && nearbyEntity != this.owner
                                ...
                                if (this.owner != null) {
                                    ...
                                    the_four_primitives_and_weapons.util.DamageCalculator.dealDamage(this.owner, nearbyEntity, sweepDamage, displayItem);
                                } else {
    ...
    private void shootArrowAt(LivingEntity target) {
        ...
        if (!arrowItem.isEmpty()) {
            int killLevel = EnchantmentHelper.getItemEnchantmentLevel(
                TheFourPrimitivesAndWeaponsModEnchantments.KILL.get(), arrowItem);
            if (killLevel > 0) {
                // killエンチャントフラグをNBTに設定
                this.getPersistentData().putBoolean("the_four_primitives_and_weapons:killentity", true);
            }
        }
        ...
        if (arrowItem.getItem() == Items.SPECTRAL_ARROW) {
            ...
            KatanaTobuEntity customArrow = new KatanaTobuEntity(TheFourPrimitivesAndWeaponsModEntities.KATANA_TOBU.get(), 
        ...
        this.getPersistentData().remove("the_four_primitives_and_weapons:killentity");
    }
