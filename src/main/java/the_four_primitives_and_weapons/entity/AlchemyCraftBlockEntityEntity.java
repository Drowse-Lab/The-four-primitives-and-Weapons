...
import the_four_primitives_and_weapons.procedures.AlchemyCraftBlockEntityOnEntityTickUpdateProcedure;
...
public class AlchemyCraftBlockEntityEntity extends Monster {
	public AlchemyCraftBlockEntityEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TheFourPrimitivesAndWeaponsModEntities.ALCHEMY_CRAFT_BLOCK_ENTITY.get(), world);
	}
