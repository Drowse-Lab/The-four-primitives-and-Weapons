...
public class KatanaTobuEntity extends AbstractArrow implements ItemSupplier {
	public KatanaTobuEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(TheFourPrimitivesAndWeaponsModEntities.KATANA_TOBU.get(), world);
	}
	...
	public static KatanaTobuEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		KatanaTobuEntity entityarrow = new KatanaTobuEntity(TheFourPrimitivesAndWeaponsModEntities.KATANA_TOBU.get(), entity, world);
	...
	public static KatanaTobuEntity shoot(LivingEntity entity, LivingEntity target) {
		KatanaTobuEntity entityarrow = new KatanaTobuEntity(TheFourPrimitivesAndWeaponsModEntities.KATANA_TOBU.get(), entity, VersionHelper.getLevel(entity));
