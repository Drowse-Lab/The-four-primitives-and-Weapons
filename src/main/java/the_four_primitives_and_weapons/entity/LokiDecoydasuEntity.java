...
import the_four_primitives_and_weapons.procedures.LokiDecoydasuFeibiDaoJugaburotukuniDangtatutatokiProcedure;
...
public class LokiDecoydasuEntity extends AbstractArrow implements ItemSupplier {
	public LokiDecoydasuEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(TheFourPrimitivesAndWeaponsModEntities.LOKI_DECOYDASU.get(), world);
	}
	...
	public static LokiDecoydasuEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		LokiDecoydasuEntity entityarrow = new LokiDecoydasuEntity(TheFourPrimitivesAndWeaponsModEntities.LOKI_DECOYDASU.get(), entity, world);
	...
	public static LokiDecoydasuEntity shoot(LivingEntity entity, LivingEntity target) {
		LokiDecoydasuEntity entityarrow = new LokiDecoydasuEntity(TheFourPrimitivesAndWeaponsModEntities.LOKI_DECOYDASU.get(), entity, VersionHelper.getLevel(entity));
