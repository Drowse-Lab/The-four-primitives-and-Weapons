...
import the_four_primitives_and_weapons.procedures.CometenteiteinotitukuGengXinShiProcedure;
import the_four_primitives_and_weapons.procedures.CometKillenteiteigaSiWangsitaShiProcedure;
...
public class CometKillEntity extends PathfinderMob {
	public CometKillEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TheFourPrimitivesAndWeaponsModEntities.COMET_KILL.get(), world);
	}

	public CometKillEntity(EntityType<CometKillEntity> type, Level world) {
		super(type, world);
		this.setMaxUpStep(0f);
		xpReward = 0;
		setNoAi(false);
