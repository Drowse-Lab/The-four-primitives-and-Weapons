...
import the_four_primitives_and_weapons.potion.HookshotFallGuardEffect;
...
/**
 * MCreator 自動生成 ({@link TheFourPrimitivesAndWeaponsModMobEffects}) の影響を受けない独自 MobEffect 登録。
 *
