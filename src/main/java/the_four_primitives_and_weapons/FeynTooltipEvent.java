    ...
    public static void onItemTooltip(ItemTooltipEvent event) {
        ...
        if (stack.hasTag() && stack.getTag().contains("Feyn")) {
            ...
            if ("cursed".equals(feyn)) {
                event.getToolTip().add(Component.translatable("tooltip.the_four_primitives_and_weapons.feyn.cursed")
                        .setStyle(Style.EMPTY.withColor(TextColor.parseColor("#BB44CC")).withItalic(false)));
            } else if ("sigiled".equals(feyn)) {
                event.getToolTip().add(Component.translatable("tooltip.the_four_primitives_and_weapons.feyn.sigiled")
                        .setStyle(Style.EMPTY.withColor(TextColor.parseColor("#3366FF")).withItalic(false)));
            } else if ("sancted".equals(feyn)) {
                event.getToolTip().add(Component.translatable("tooltip.the_four_primitives_and_weapons.feyn.sancted")
