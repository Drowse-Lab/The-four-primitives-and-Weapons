...
import the_four_primitives_and_weapons.procedures.SmithingTableGui2konoGUIgaKaikareteiruJiannoteitukuProcedure;

import the_four_primitives_and_weapons.network.SmithingTableGui2SlotMessage;
...
public class SmithingTableGui2Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public SmithingTableGui2Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(TheFourPrimitivesAndWeaponsModMenus.SMITHING_TABLE_GUI_2.get(), id);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			TheFourPrimitivesAndWeaponsMod.PACKET_HANDLER.sendToServer(new SmithingTableGui2SlotMessage(slotid, x, y, z, ctype, meta));
