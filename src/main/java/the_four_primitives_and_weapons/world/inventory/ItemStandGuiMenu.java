...
public class ItemStandGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ItemStandGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(TheFourPrimitivesAndWeaponsModMenus.ITEM_STAND_GUI.get(), id);
