...
public class AngelTrioRenderer extends HumanoidMobRenderer<AngelTrioEntity, PlayerModel<AngelTrioEntity>> {
    ...
    // 人格ごとのスキン
    private static final ResourceLocation SKIN_SERIOUS = new ResourceLocation("the_four_primitives_and_weapons", "textures/entity/angel_trio/angel_serious.png");
    private static final ResourceLocation SKIN_MOCKER1 = new ResourceLocation("the_four_primitives_and_weapons", "textures/entity/angel_trio/angel_mocker1.png");
    private static final ResourceLocation SKIN_MOCKER2 = new ResourceLocation("the_four_primitives_and_weapons", "textures/entity/angel_trio/angel_mocker2.png");
    // フォールバック
